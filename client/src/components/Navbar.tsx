...
const Navbar = () => {
  return (
    <div className='flex  justify-between items-center bg-white border-b-2 px-4 border-gray-200 w-full h-[9vh]'>
        ...
        <button className="hover:bg-gray-300/30 h-[36px] w-[36px] p-1 cursor-pointer rounded flex items-center justify-center">
            <Bell size={20}  />
        </button>
        <button className="hover:bg-gray-300/30 h-[36px] w-[36px] p-1 cursor-pointer rounded flex items-center justify-center">
            <Wallet size={20}  />
        </button>
        <button className=" h-[30px] w-[30px] p-1 cursor-pointer rounded flex items-center justify-center">
