...
import { Edit, Trash2, ToggleLeft, ToggleRight, PackagePlus, Search, Package } from "lucide-react"
              ...
              <div className="p-4 flex flex-col gap-2.5 flex-1">
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-2 text-red-500 hover:bg-red-50 border border-red-100 rounded-xl text-xs font-semibold transition"
                  >
                    <Trash2 size={13} />
                    Delete
                  </button>
